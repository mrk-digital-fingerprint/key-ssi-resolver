...
function BarFactory(options) {
    ...
    const createInstance = (did, options) => {
        ...
        let anchorVerificationStrategyName = options.anchorVerificationStrategyName;
        let anchorVerificationStrategyOptions = options.anchorVerificationStrategyOptions;
        if (!anchorVerificationStrategyName) {
            anchorVerificationStrategyName = DEFAULT_ANCHOR_VERIFICATION_STRATEGY;
        }
        const anchorVerificationStrategy = createAnchorVerificationStrategy(anchorVerificationStrategyName, anchorVerificationStrategyOptions);
     ...
     * @return {object}
     */
    const createAnchorVerificationStrategy = (name, options) => {
        const strategy = this.anchorVerificationStrategyFactory.create(name, options);
        return strategy;
    }
