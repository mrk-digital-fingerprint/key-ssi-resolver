...
function Factory(options) {
     ...
     * @param {callback} dsuConfiguration.anchoringOptions.decissionCb Callback which will decide when to effectively anchor changes
     *                                                              If empty, the changes will be anchored after each operation
     * @param {callback} dsuConfiguration.anchoringOptions.conflictResolutionCb Callback which will handle anchoring conflicts
