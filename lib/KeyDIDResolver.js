...
function KeyDIDResolver(options) {
    ...
    this.anchorVerificationStrategyFactory = options.anchorVerificationStrategyFactory || new AnchorVerificationStrategyFactory();
    ...
    this.dsuFactory = options.dsuFactory || new DSUFactory({
        ...
        anchorVerificationStrategyFactory: this.anchorVerificationStrategyFactory
    });
    ...
    this.loadDSU = (did, dsuRepresentation, options, callback) => {
        ...
        this.dsuFactory.load(did, dsuRepresentation, options, callback);
    };
