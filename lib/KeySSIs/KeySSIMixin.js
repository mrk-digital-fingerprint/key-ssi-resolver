...
const KeySSIMixin = {
    ...
    getAnchorId: function(){
        const keySSIFactory = require("./KeySSIFactory");
        return cryptoRegistry.getHashFunction(this)(keySSIFactory.getAnchorType(this).getIdentifier());
    },

    getAnchorIdBase58: function(){
        const keySSIFactory = require("./KeySSIFactory");
        return pskCrypto.pskBase58Encode(keySSIFactory.getAnchorType(this).getIdentifier());
    },
