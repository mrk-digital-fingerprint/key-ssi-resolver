...
const KeySSIMixin = {
    ...
    autoLoad: function (identifier) {
        ...
        this.subtypeSpecificString = this.cryptoRegistry.getDecodingFunction(this.vn)(this.subtypeSpecificString);
    },
    ...
    getDerivedType: function(keySSIType) {
        const KeySSIFactory = require("./KeySSIFactory");
        return KeySSIFactory.getDerivedType(this, keySSIType);
    },

    getAnchorAlias: function(){
        const keySSIFactory = require("./KeySSIFactory");
        return this.cryptoRegistry.getHashFunction(this.vn)(keySSIFactory.getAnchorType(this).getIdentifier());
    },
