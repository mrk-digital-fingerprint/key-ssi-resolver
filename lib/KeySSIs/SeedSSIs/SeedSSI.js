...
function SeedSSI(identifier) {
    ...
    this.derive = function() {
        ...
        const subtypeKey = cryptoRegistry.getHashFunction(this)(getEncryptionKey());
        const publicKey = cryptoRegistry.getKeyPairGenerator(this)().getPublicKey(getEncryptionKey());
